            ...
            <div className="flex justify-center mb-6 px-4 sm:px-9">
              ...
              >
                <InputOTPGroup className="flex gap-1 sm:gap-2">
                  <InputOTPSlot index={0} className="w-10 h-12 sm:w-12 sm:h-16 rounded-md border border-solid border-[#cccccc] bg-wwwpaypalcomwhite text-lg" />
                  <InputOTPSlot index={1} className="w-10 h-12 sm:w-12 sm:h-16 rounded-md border border-solid border-[#cccccc] bg-wwwpaypalcomwhite text-lg" />
                  <InputOTPSlot index={2} className="w-10 h-12 sm:w-12 sm:h-16 rounded-md border border-solid border-[#cccccc] bg-wwwpaypalcomwhite text-lg" />
                  <InputOTPSlot index={3} className="w-10 h-12 sm:w-12 sm:h-16 rounded-md border border-solid border-[#cccccc] bg-wwwpaypalcomwhite text-lg" />
                  <InputOTPSlot index={4} className="w-10 h-12 sm:w-12 sm:h-16 rounded-md border border-solid border-[#cccccc] bg-wwwpaypalcomwhite text-lg" />
                  <InputOTPSlot index={5} className="w-10 h-12 sm:w-12 sm:h-16 rounded-md border border-solid border-[#cccccc] bg-wwwpaypalcomwhite text-lg" />
                </InputOTPGroup>
              </InputOTP>
            </div>
            ...
            <div className="flex items-start gap-2 px-4 sm:px-10 mb-1">
              ...
              <div className="flex flex-col">
                <label
                  ...
                  className="[font-family:'Helvetica_Neue-Regular',Helvetica] font-normal text-wwwpaypalcomblack text-sm tracking-[-0.28px] leading-[18px]"
                >
                  Dieses Gerät merken
                </label>
