        ...
        <Card className="w-full max-w-[400px] bg-wwwpaypalcomwhite border-none shadow-none">
          ...
          <CardContent className="px-0">
            <div className="text-center mb-6">
              <h3 className="font-www-paypal-com-semantic-heading-3 text-wwwpaypalcomblack text-2xl sm:text-3xl tracking-[var(--www-paypal-com-semantic-heading-3-letter-spacing)] leading-[var(--www-paypal-com-semantic-heading-3-line-height)]">
